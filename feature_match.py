...
license_plate = cv2.imread("D:/andys/Documents/Kean University/4 Spring 2021/Senior Project/ProjCode/RESTART/20210325_113555.jpg",0)
display(license_plate)

#reads in the car image
car = cv2.imread("D:/andys/Documents/Kean University/4 Spring 2021/Senior Project/ProjCode/RESTART/cropped_vehicle/upscaled/veh_1323.jpg",0)
display(car)


def FAST_n_BRIEF(img1, img2, n=80, threshold=35):
    ...
    cv2.imwrite("D:/andys/Documents/Kean University/4 Spring 2021/Senior Project/ProjCode/RESTART/feature_match.jpg",result)

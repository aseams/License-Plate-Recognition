...
def main():
	...
	images = [x for x in Path('D:/andys/Documents/Kean University/4 Spring 2021/Senior Project/ProjCode/RESTART/Final/LicPlateImages').iterdir() if x.suffix.lower() in extensions]
	for img in images:
